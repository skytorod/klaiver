		...
		<div id="paper">
			...
			<div id="company_profile">
				...
				<div id="company_info">
					...
					<ul id="page_move">
						<li class="on"><a href="searchNews?userid=${IndividualVO.email}">Home</a></li>
						...
						<form id="formFile" method="POST" encType="multipart/form-data">
							<c:forEach items="${sessionidName}" var="sessionidName">
								<span class="personal_img"> <img
									src="../resources/img/${sessionidName.profimg}"
									onclick="doImgPop('../resources/img/${sessionidName.profimg}')" />
								</span>

								<ul class="title_box">
									
										<li class="name"><input type="hidden" name="warea"
											id="warea" value="${sessionidName.email}" /> <input
